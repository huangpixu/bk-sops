...
CC_GET_IPS_INFO_BY_STR_IPV6 = (
    "pipeline_plugins.variables.collections.sites.open.cmdb." "var_cmdb_set_module_ip_selector.cc_get_ips_info_by_str_ipv6"
)
...
class VarCmdbSetModuleIpSelectorTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.list_biz_hosts_patcher = patch(
            LIST_BIZ_HOSTS,
            MagicMock(side_effect=mock_list_biz_hosts)
        )
        ...
        def mock_find_module_with_relation(tenant_id, bk_biz_id, username, set_ids, service_template_ids, fields):
            print(f"DEBUG: find_module_with_relation called with set_ids={set_ids}, service_template_ids={service_template_ids}")
            result = []
        ...
        self.find_module_with_relation_patcher = patch(
            ...
            MagicMock(side_effect=mock_find_module_with_relation)
        )
